...
In general a project that should be transferred to Hiero must fulfill the [Hiero Project Criteria](project-criteria.md).
Please review the document before starting the transfer process.
...
More information about that and other Hiero appointments and events can be found in our [public calender](https://zoom-lfx.platform.linuxfoundation.org/meetings/lf-decentralized-trust?view=week).
