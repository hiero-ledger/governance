# Repo Rules Exceptions for hiero-ledger projects

This document serves as a record of project-specific exceptions to the [Hiero Ledger Roles and Groups document](../roles/roles-and-groups.md). These governance rules are designed to ensure consistent and collaborative project management across the hiero-ledger GitHub organization. However, exceptions may be proposed when specific project needs warrant deviation from the standard roles and group structures.
