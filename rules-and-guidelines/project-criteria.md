...
The following criteria are defined by the Hiero TSC and must be met for a project to be considered for inclusion in [hiero-ledger](https://github.com/hiero-ledger).
...
- Information on project licenses can be found in LFDT's TAC [Allowed Third Party Licenses](https://lf-decentralized-trust.github.io/governance/governing-documents/allowed-third-party-licenses/)
